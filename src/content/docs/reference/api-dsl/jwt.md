---
title: API JWT Auth
description: Declare JWT authentication in an .api file.
sidebar:
  order: 8
...
2. [JWT Authentication guide](../../guides/http/jwt-auth.md)
...
type Config struct {
    rest.RestConf
    // Auth configures the JWT signing key and token expiration.
    Auth struct {
        AccessSecret string
        AccessExpire int64
    }
